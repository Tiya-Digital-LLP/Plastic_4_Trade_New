...
class Result {
  ...
  Result({
    ...
    _trusted_status = trusted_status;
  ...
  String? get verify_status => _verify_status;
  set verify_status(String? verify_status) => _verify_status = verify_status;

  int? get trusted_status => _trusted_status;
  set trusted_status(int? trusted_status) => _trusted_status = trusted_status;
  // Getters and setters for new fields
  int? get isBusinessProfileView => _isBusinessProfileView;
  set isBusinessProfileView(int? value) => _isBusinessProfileView = value;

  int? get isBusinessOldView => _isBusinessOldView;
  set isBusinessOldView(int? value) => _isBusinessOldView = value;
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    _verify_status = json['verification_status'];
    _trusted_status = json['trusted_status'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['verification_status'] = _verify_status;
    data['trusted_status'] = _trusted_status;
