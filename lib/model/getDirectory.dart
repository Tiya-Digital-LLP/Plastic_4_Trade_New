...
class Result {
  ...
  int? get primePlanId => _primePlanId;
  set primePlanId(int? premiumPlanName) => _primePlanId = primePlanId;
  ...
  Result.fromJson(Map<String, dynamic> json) {
    ...
    _primePlanId = json['prime_plan_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['prime_plan_id'] = _primePlanId;
