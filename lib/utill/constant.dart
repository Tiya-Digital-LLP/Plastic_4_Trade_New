...
class constanst {
  ...
  static List<String> Product_Capcity_name = [];
  ...
  static List<String> designationpartner2 = [];

  static List<String> core_business = [];

  static List<String> lstBussiness_nature_name = [];
  static List<String> selectcategory_id = [];
  static List<String> selectbusstype_id = [];
  static List<String> selectcore_id = [];
  static List<String> selectdesignation_id = [];
  static List<String> selectdesignatiopartner2_id = [];
  ...
  static List<String> select_product_cap_id = [];
  ...
  static List<String> select_typename = [];
  static String select_grade_id = "";
  static List<String> select_gradname = [];
  ...
  static int step = 0;
  static bool email_verified = false;
...
// get Category
  ...
  static List<IconData> core_type_itemsCheck = [];
