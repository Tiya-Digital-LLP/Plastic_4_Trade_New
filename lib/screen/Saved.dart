...
class _SavedState extends State<Saved> {
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                isload == true ? category() : favWithShimmerLoader(context)
              ],
            ),
          ),
        ),
  ...
  Widget favWithShimmerLoader(BuildContext context) {
                                          ...
                                          showDialog(
                                              ...
                                              builder: (context) {
                                                return CommanDialog(
                                                  title: "Saved",
                                                  content:
                                                      "Do you want to UnSaved",
                                                  onPressed: () {
                                                    setState(() {
                                                      getremove_product(record
                                                          .productId
                                                          .toString());
