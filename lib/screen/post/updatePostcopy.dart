...
class Updatepostcopy extends StatefulWidget {
  String? post_type;
  String? prod_id;

  Updatepostcopy(this.post_type, this.prod_id, {Key? key}) : super(key: key);

  @override
  State<Updatepostcopy> createState() => _UpdatePOstState();
}
...
class _UpdatePOstState extends State<Updatepostcopy> {
                                ...
                                GestureDetector(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Row(
                                      children: [
                                        GestureDetector(
                                          child: sampleData1.last.isSelected ==
                                                  true
                                              ? Icon(Icons.check_circle,
                                                  color:
  ...
  Future<bool> update_BuyPost() async {
    ...
    // Logging product ID and selected images
    print('Product ID: ${widget.prod_id}');
    print('Selected Images: [file: $file, file1: $file1, file2: $file2]');

    // Add image API call logging
    var addImageResult = await addimage(
      prod_id: widget.prod_id.toString(),
      images: [file, file1, file2],
    );

    // Add image result check
    if (addImageResult == null) {
      print('Failed to add images');
      return false;
    }
    print('Add Image API Result: $addImageResult');
    ...
    // Logging all the parameters for the updateBuyerPost API call
    print('User ID: ${pref.getString('user_id')}');
    print('API Token: ${pref.getString('userToken')}');
    print('Selected Type IDs: ${constanst.select_typeId.join(",")}');
    print('Selected Grade IDs: ${constanst.select_gradeId.join(",")}');
    print('Select Item 4: $_selectitem4');
    print('Product Price: ${_prodprice.text}');
    print('Product Quantity: ${_prodqty.text}');
    print('Selected Color IDs: ${constanst.color_id_list.join(",")}');
    print('Product Detail: ${_proddetail.text}');
    print('Select Item 5: $_selectitem5');
    print('Select Item 6: $_selectitem6');
    print('Location: ${_loc.text}');
    print('Latitude: $lat');
    print('Longitude: $log');
    print('City: $city');
    print('State: $state');
    print('Country: $country');
    print('Product Name: ${_prodnm.text}');
    print('Selected Category IDs: ${constanst.select_categotyId.join(",")}');
    print('Alter Main Image URL: $alterMainImageUrl');
    print('Product ID: ${widget.prod_id}');
    print('App Version: ${constanst.version}');
