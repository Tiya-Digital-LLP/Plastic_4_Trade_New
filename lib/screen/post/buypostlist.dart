...
class Buypostlist extends StatefulWidget {
  const Buypostlist({super.key});

  @override
  State<Buypostlist> createState() => _BuypostlistState();
}

class _BuypostlistState extends State<Buypostlist> {
          ...
          slivers: [
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                ...
                childCount: buyerpost_data.length + 1,
              ),
            ),
          ],
        ),
